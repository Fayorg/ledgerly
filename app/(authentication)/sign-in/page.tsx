...
export default function SignUpPage() {
	...
	return (
		<>
			...
			<div className="container relative px-2 grid h-screen flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0">
				<Link href="/sign-up" className={cn(buttonVariants({ variant: 'ghost' }), 'absolute right-4 top-4 md:right-8 md:top-8')}>
					Sign-up
				</Link>
				<div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
					...
					<div className="w-full h-full flex justify-center items-center">
						<div className="w-1/2 h-1/2 rounded-xl overflow-hidden select-none">
							<Ledgerly />
						</div>
					</div>
				...
				<div className="lg:p-8">
					<div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
						<div className="flex flex-col space-y-2 text-center">
							...
							<p className="text-sm text-muted-foreground">Enter your email below to sign into your account</p>
						</div>
						<UserAuthForm />
